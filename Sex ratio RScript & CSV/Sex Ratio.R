...
library(gridExtra)
library(grid)
setwd("C:\\Users\\Nicole Lee\\Desktop\\Pamela analyses check\\Sex Ratio")

sex<-read.csv("C:\\Users\\Nicole Lee\\Desktop\\Pamela analyses check\\Sex Ratio\\Survivorship_NL.csv", na.strings= c('#DIV/0!', '', 'NA'),stringsAsFactors = F)
head(sex)
#sex<- na.omit(sex)
